...
public class PokerController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        PlayerCard1.setImage((poker.hands[0][0].cardImage));
        PlayerCard2.setImage((poker.hands[0][1].cardImage));
    ...
    public void checkButtonClick(){
        ...
        if(i==1) {
            ...
            CommunityCard1.setImage((poker.hands[6][0].cardImage));
            CommunityCard2.setImage((poker.hands[6][1].cardImage));
            CommunityCard3.setImage((poker.hands[6][2].cardImage));
            i++;
            CorrectionText.setText("");
        }
        else if(i==2){
            CommunityCard4.setImage((poker.hands[6][3].cardImage));
            i++;
            CorrectionText.setText("");
        }
        else if(i==3){
            CommunityCard5.setImage((poker.hands[6][4].cardImage));
            i++;
            CorrectionText.setText("");
        }
        else if(i==4){
